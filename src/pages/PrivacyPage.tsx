...
const SECTIONS = [
  {
    ...
    content: `IDly(이하 "서비스")는 서비스 제공을 위해 다음과 같은 정보를 수집합니다.

■ Google 계정을 통한 로그인 시 수집 항목
- 이름, 이메일 주소, 프로필 사진 (Google OAuth 기본 정보)

■ Gmail 데이터 접근 (gmail.readonly 권한)
...
Gmail 데이터는 오직 계정 보안 분석 목적으로만 사용되며, 광고·마케팅·제3자 제공 등 다른 목적으로 사용하지 않습니다.`,
  },
  {
    ...
    content: `- 회원 탈퇴 시까지 보관 후 즉시 파기합니다.
...
- 관계 법령에 따라 보존이 필요한 경우 해당 기간 동안 별도 보관합니다.`,
  },
  {
    ...
    content: `IDly는 수집된 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우는 예외로 합니다.
...
Gmail 계정 데이터는 어떠한 경우에도 제3자에게 판매·임대·공유되지 않습니다.`,
  ...
  {
    title: "5. 개인정보 처리 위탁",
    content: `IDly는 서비스 운영을 위해 아래 업체에 개인정보 처리를 위탁합니다.

| 수탁업체 | 위탁 업무 |
| --- | --- |
| Supabase Inc. | 데이터베이스 관리 |
| Render Inc. | 서버 운영 |
| Google LLC | 인증 및 Gmail API 제공 |

위탁 업체들은 위탁 업무 처리 외 목적으로 개인정보를 이용하지 않으며, 계약 종료 시 즉시 반환·파기합니다.`,
  },
  {
    title: "6. 이용자의 권리 및 행사 방법",
    content: `이용자는 언제든지 다음의 권리를 행사할 수 있습니다.

- **개인정보 열람**: 마이 → 개인정보 관련 문의를 통해 요청
- **개인정보 수정**: 앱 내 프로필 설정 화면에서 직접 수정
- **Gmail 연동 해제**: 마이 → 계정 관리에서 직접 해제 가능
- **Google 권한 취소**: Google 계정의 "계정에 액세스할 수 있는 앱"에서 IDly 권한 직접 철회 가능
- **회원 탈퇴 및 데이터 삭제**: 마이 → 회원 탈퇴를 통해 모든 개인정보 즉시 삭제`,
  },
  {
    title: "7. 개인정보의 파기",
    content: `보유 기간이 경과하거나 처리 목적이 달성된 경우 다음과 같이 파기합니다.
...
이메일 원문은 AI 분석 완료 즉시 파기하며 IDly 서버에 저장되지 않습니다.`,
  ...
  {
    title: "8. 개인정보 보호책임자",
    content: `개인정보 처리에 관한 업무를 총괄하며, 개인정보 관련 문의·불만 처리를 담당합니다.
...
- 이메일: idly1apt@gmail.com`,
  ...
  {
    title: "9. 개인정보처리방침 변경",
    content: `이 개인정보처리방침은 2026년 8월 31일부터 적용됩니다. 내용이 변경될 경우 앱 내 공지 또는 이 페이지를 통해 안내드립니다.`,
  },
];
